...
export default function RajVivaEvents() {
  return (
    <>
      <Head>
        <title>RajViva Events – Premium Wedding Planner in Udaipur</title>
        <meta
          name="description"
          content="RajViva Events is a premium wedding planner in Udaipur offering royal themes, luxury décor, destination weddings & full management."
        />
      </Head>
      ...
      <header className="planner-hero">
        <div className="hero-contenttt">
          ...
          <h1>RajViva Events</h1>
          <p>
            Udaipur’s trusted premium wedding planner for luxury, royal &
      ...
      <main>
        ...
        <section className="section">
          <div className="container">
            <h2>About RajViva Events</h2>
            <p>
              RajViva Events is a premium wedding planning company in Udaipur,
        ...
        <section className="section light">
          <div className="container center">
            ...
            <p>
              Get a personalized consultation with one of Udaipur’s top 
              wedding planners.
            </p>
            <br />
            <a
