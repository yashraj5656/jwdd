  ...
  return (
    <>
      ...
      <main>
        ...
        <section className="section light">
          <div className="container">
            <h2>Top Royal Wedding Planners in Jaipur</h2>
            <div className="cards">
              <div className="card">
                <h3>Fiestro Events</h3>
                <p>Luxury royal themes with impeccable execution.</p>
              </div>
              <div className="card">
                <h3>Shaandaar Events</h3>
                <p>Specialists in palace weddings and royal décor.</p>
              </div>
              <div className="card">
                <h3>The Wedding Toli</h3>
                <p>Full-service for grand royal celebrations.</p>
              </div>
              <div className="card">
                <h3>Wedding Vision</h3>
                <p>Bespoke royal weddings with regal touches.</p>
              </div>
              <div className="card">
                <h3>Dot&Dot Events</h3>
                <p>Detail-oriented royal event planning.</p>
              </div>
            </div>
          </div>
        </section>
