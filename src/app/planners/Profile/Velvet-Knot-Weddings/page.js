...
export default function VelvetKnotWeddings() {
  return (
    <>
      <Head>
        <title>Velvet Knot Weddings – Premium Wedding Planner in Jaipur</title>
        <meta
          name="description"
          content="Velvet Knot Weddings is a premium wedding planner in Jaipur offering royal themes, luxury décor, destination weddings & full management."
        />
      </Head>
